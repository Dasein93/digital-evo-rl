...
- `python -m train.tools.coevolve --seed_ckpt <ckpt> --out <dir> --generations G --n_mutants N --sigma S [--n_obstacles K] [--workers W] [--resume] [--num_threads K]`
